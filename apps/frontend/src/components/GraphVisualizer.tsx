...
export default function GraphVisualizer() {
  ...
  const { tickDataRef, quadtreeRef, isLoading, error, postWorkerMessage } = useGraphState();
  ...
  }, [tickDataRef, scaleRef, offsetXRef, offsetYRef, draggedNodeIdRef, hoveredNodeIdRef]);
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLCanvasElement>) => {
    ...
    switch (e.key) {
      case 'ArrowUp': offsetYRef.current += PAN_STEP; break;
      case 'ArrowDown': offsetYRef.current -= PAN_STEP; break;
      case 'ArrowLeft': offsetXRef.current += PAN_STEP; break;
      case 'ArrowRight': offsetXRef.current -= PAN_STEP; break;
      case '+': 
      case '=':
